...
public class ExternalRosterUnitStatActuel implements UnitStatValues {
    ...
    @SequenceGenerator(name = "external_roster_unit_stat_actuel_seq", sequenceName = "external_roster_unit_stat_actuel_seq", allocationSize = BatchConstants.SEQUENCE_ALLOCATION_SIZE)
    private Long id;
