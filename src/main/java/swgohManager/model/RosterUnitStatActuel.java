...
indexes = {
	        @Index(name = "rusaidx_playerId", columnList = "playerId"),
	        @Index(name = "rusaidx_idUnit", columnList = "idUnit")
			})
@Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
public class RosterUnitStatActuel implements UnitStatValues {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "roster_unit_stat_actuel_seq")
    @SequenceGenerator(name = "roster_unit_stat_actuel_seq", sequenceName = "roster_unit_stat_actuel_seq", allocationSize = BatchConstants.SEQUENCE_ALLOCATION_SIZE)
    private Long id;
